...
>
  <thead>
    <tr class="bg-gray-100 border-b-2 border-gray-400 font-semibold">
      ...
      <td class="hidden p-3 sm:block">
        <input
          class="bg-gray-100 focus:outline-none border-b border-gray-400 py-1 px-3 block w-full
  ...
  <tbody>
    {#each coins as { symbol, name, rank, priceUsd, marketCapUsd, changePercent24Hr }}
      <tr class="border-b border-gray-200 hover:bg-gray-100">
        ...
        <td>
          <a class="hover:underline text-green-600" href="/">{name}</a>
